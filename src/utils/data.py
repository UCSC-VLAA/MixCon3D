...
"""
The summary of current used augmentation for Point Cloud:
(normalize, I think normalization isn't a kind of augmentation)
    1) rotate_z 
    2) point_dropout
    3) scale_point_cloud
    4) shift_point_cloud
    5) rotate_perturbation_point_cloud

These five augmentations are only used for (x, y, z) coordinates.
"""
